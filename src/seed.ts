import { Project, Contributor, Commit, CoreMember, BrandSponsor, Donor } from './types';
...
export const INITIAL_PROJECTS: Project[] = [
  ...
  {
    "problemDescription": "妈妈为了帮我编织餐厅红酒杯带和法棍包，不得不每天晚上在台灯下拿着A4打印纸，眼睛贴得极近去数极其细小的格子和针脚。由于没有趁手的放大打印辅助工具，手绘图样不仅耗时极长，还给妈妈的眼睛带来了极大的负担。“要是你能给我想办法打印出来纹样，尽量放大一点，没有我织不出来的！”妈妈的这句话，让人心疼又感动。",
    "readmeStory": "# 为最具体的人，织一万个梦 - LoomGrid 诞生记\n\n## 🦖 恐龙毛衣与那抹自豪\n小时候，我穿上妈妈给我织的那件极其精美、立体的恐龙毛衣，走在学校的操场上，迎着所有同学羡慕的目光，那种自豪感和幸福感是后来买任何高档衣服也无法带来的。\n\n妈妈的手有魔力。如今，我开了自己的餐厅，妈妈不仅没有停下手中的针线，反而兴致勃勃地为我的餐厅编织各式各样的红酒杯带、法棍包……每一次把那些细致、富有质感的织品递给我时，她眼里都闪烁着欣喜的光芒，那是一种最纯粹的爱与礼赠。\n\n## 💡 台灯下的A4纸与数格子的眼眸\n然而，直到有一次深夜我回到家，看到妈妈坐在灯光微弱的桌前。她手里拿着一叠 A4 纸，眼睛凑得极其近，正吃力地用铅笔在上面画着密密麻麻的格子，嘴里还在念念有词地数着针脚。我突然猛地意识到——原来，为了满足我天马行空的创意，妈妈需要在每一个夜深人静的时刻，如此吃力地在小小的格子里一针一针计算着。这对于视力日益下降的她来说，绝非一件简单的事。\n\n看着那一叠满是修改痕迹、密密麻麻的小方格，那一刻，我的心像被针扎一样疼。\n\n“要是你能给我想办法打印出来纹样，尽量放大一点，没有我织不出来的！”\n\n妈妈抬起头，虽然有些疲惫，但说这句话的时候，她的眼睛里依旧有着属于创作者的热切与自豪，那是光芒在闪烁。\n\n## 🧶 Loomscape：只为具体的一个人而做\n那一刻我暗下决心，我要为妈妈写一个工具。\n我们不要做功能最复杂的制图软件，不要做那些充满了像素算法、针法公式、只有专业设计师才懂的工业化软件。我们只想做一个妈妈能一键上手、字够大、网格够清、能一键把它放大到最大然后顺顺利利打印出来的暖心伙伴。\n\n这就是 **Loomscape** 的起点。第一个工具是为我的妈妈做的，以后还会有第二个、第三个……\n\n我们不做庞大的、冰冷的通用平台。**我们做的每一个小而美的工具，都只为了一个鲜活、具体的、我们深深爱着的人。**",
    "status": "approved",
    "tagline": "让妈妈在灯下不再费力数格子，一键放大并打印个性化编织网格的温柔工具",
    "targetPerson": {
      "name": "社鸾 (She Luan)",
      "description": "韩续的妈妈，极其热爱编织。小时候为韩续织立体恐龙毛衣，如今为他的餐厅编织红酒杯带、法棍包。她通过手绘图样、对着A4纸艰难数格和数针脚来做编织制图。",
      "relationship": "母亲 / 编织热爱者"
    },
    "createdAt": "2026-07-16T08:00:06.930Z",
    "title": "编织网格打印器 / LoomGrid Printer",
    "solutionDescription": "我们不做功能最多、最复杂的编织制图软件，只为妈妈打造一个最极致、简单且轻松上手的“网格图案放大与打印伙伴”。用户只需上传手绘图样或导入图案，程序即可一键将其转换为高对比度的网格图，并能自由调整行距、列宽以及线号标注，支持超大无边距、多页拼接打印。它能让妈妈用最大的字体、最舒适的网格，继续做她最爱的手艺。",
    "readmeProject": "# LoomGrid Printer - 极简编织网格放大与打印工具\n\n这是一个为了让热爱编织的母亲能更轻松看清网格图样、数清针脚而量身定制的前端轻量级网格放大与无缝拼接打印伙伴。\n\n## 🌸 核心特性\n* **超大网格渲染**：一键上传手绘图纸或纹样，自动转换为高清晰、大字号的针脚网格图，方便中老年人查看。\n* **自适应放大与拼接打印**：支持将一幅大图切割放大到多张 A4 纸上无缝拼接打印，不再受限于极小的打印区域纸张。\n* **极简傻瓜式交互**：没有繁杂的专业术语，采用超大按钮与清晰指引，妈妈一分钟即可上手。\n* **本地运行无丢失**：所有上传的图样和设计的网格直接在浏览器中渲染处理，不上传服务器，保护家人的个人手稿与心血。\n\n## 🛠️ 简易部署\n运行以下命令即可立即本地启动体验：\n```bash\nnpm install\nnpm run dev\n```\n即可在浏览器中开启最温情的编织网格打印体验。",
    "demoUrl": "https://github.com/amusingcompany/loomgrid#demo",
    "author": {
      "email": "xisco.han@gmail.com",
      "name": "韩续 (Han Xu)",
      "github": "amusingcompany",
      "avatarUrl": "https://github.com/amusingcompany.png"
    },
    "githubUrl": "https://github.com/amusingcompany/loomgrid",
    "id": "project-loomgrid",
    "likes": 120,
    "tags": ["React", "编织", "打印辅助", "老年人友好"]
  }
];
    ...
    "projectLinks": [
      {
        ...
        "title": "LoomGrid Printer / 编织网格打印器",
        "url": "https://github.com/amusingcompany/loomgrid"
      }
    ],
    "id": "cm-amusingcompany",
    "github": "amusingcompany",
    "websiteUrl": "https://github.com/amusingcompany"
  }
];
export const INITIAL_BRAND_SPONSORS: BrandSponsor[] = [];
